...
BRAND_LOGO_SOURCE="${JADE_CUB_DMG_LOGO_SOURCE:-${PING_ISLAND_DMG_LOGO_SOURCE:-$PROJECT_DIR/PingIsland/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png}}"
...
DMG_ICON_SOURCE="${JADE_CUB_DMG_ICON_SOURCE:-${PING_ISLAND_DMG_ICON_SOURCE:-}}"
FALLBACK_ICON_PNG="$PROJECT_DIR/PingIsland/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png"

VOLNAME=""
SOURCE_DIR=""
OUTPUT_DMG=""
APP_NAME="Jade Cub.app"
WINDOW_WIDTH="${JADE_CUB_DMG_WINDOW_WIDTH:-${PING_ISLAND_DMG_WINDOW_WIDTH:-768}}"
WINDOW_HEIGHT="${JADE_CUB_DMG_WINDOW_HEIGHT:-${PING_ISLAND_DMG_WINDOW_HEIGHT:-512}}"
ICON_SIZE="${JADE_CUB_DMG_ICON_SIZE:-${PING_ISLAND_DMG_ICON_SIZE:-108}}"
APP_X="${JADE_CUB_DMG_APP_X:-${PING_ISLAND_DMG_APP_X:-212}}"
APP_Y="${JADE_CUB_DMG_APP_Y:-${PING_ISLAND_DMG_APP_Y:-246}}"
APPLICATIONS_X="${JADE_CUB_DMG_APPLICATIONS_X:-${PING_ISLAND_DMG_APPLICATIONS_X:-602}}"
APPLICATIONS_Y="${JADE_CUB_DMG_APPLICATIONS_Y:-${PING_ISLAND_DMG_APPLICATIONS_Y:-248}}"
FAIL_ON_PLAIN="${JADE_CUB_DMG_FAIL_ON_PLAIN:-${PING_ISLAND_DMG_FAIL_ON_PLAIN:-0}}"
FINDER_VOLUME_NAME=""
...
Environment:
  JADE_CUB_DMG_BACKGROUND_SOURCE     Optional background image override
EOF
}
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/jade-cub-dmg.XXXXXX")"
