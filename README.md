...
> This preview build is ad-hoc signed and not notarized. On first launch, macOS may require Control-click -> Open or `System Settings -> Privacy & Security -> Open Anyway`. Jade Cub may also ask for Accessibility / Apple Events permissions for focus-return features.
